...
void SkinnedMeshApp::GetAvailableFrameResource()
{
...
void SkinnedMeshApp::LoadTextures()
{
  ...
  for (UINT i = 0; i < mSkinnedMats.size(); ++i)
  {
    ...
    std::wstring diffuseFilename = L"../../Textures/" + converter.from_bytes(diffuseName);
    std::wstring normalFilename = L"../../Textures/" + converter.from_bytes(normalName);
